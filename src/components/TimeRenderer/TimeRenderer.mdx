...
- This component is rendering a date using a "*medium*" time style format option. Alternative: use the `DateTimeRenderer` component, which is allowing to define and use custom format options.
