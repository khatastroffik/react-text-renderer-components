...
<section className="accordion">
  ...
  <div className="content">
    <Source code={`
<DateRenderer value={new Date()} /> &rarr; <QuarterRenderer value={new Date()} />
<DateRenderer value={new Date("2024-12-31T11:11:11.111Z")} /> &rarr; <QuarterRenderer value={new Date("2024-12-31T11:11:11.111Z")} pure />
<DateRenderer value={new Date("2025-01-01T11:11:11.111Z")} /> &rarr; <QuarterRenderer value={new Date("2025-01-01T11:11:11.111Z")} displayYear pure />
<DateRenderer value={new Date("2026-04-28T11:11:11.111Z")} /> &rarr; <QuarterRenderer value={new Date("2026-04-28T11:11:11.111Z")} pure />
<DateRenderer value={new Date("2027-07-31T11:11:11.111Z")} /> &rarr; <QuarterRenderer value={new Date("2027-07-31T11:11:11.111Z")} displayYear pure />
<DateRenderer value={new Date("2027-10-04T11:11:11.111Z")} /> &rarr; <QuarterRenderer value={new Date("2027-10-04T11:11:11.111Z")} displayYear />
    `} dark />
  </div>
  <p>Note: the Date value passed as property to the TimeRenderer component should be a **UTC** date</p>
</section>
...
<section className="accordion">
  ...
  <div className="content">
    <Source code={`
<DateRenderer value={new Date()} /> &rarr; <WeekRenderer value={new Date()} />
